...
export const ADVIES_SYSTEM = [
  ...
  "Het pakket is plat; deze regels zeggen wat erin staat, zodat je het niet verkeerd leest.",
  "- Bewegen levert punten op die bovenop het dagbudget van díe dag komen.",
  "  budget.adherence_rate en by_weekday.*.over_budget_rate tellen die al mee: een dag boven",
  "  het dagbudget kan er dus binnen vallen. budget.avg_points_per_day en de mediaan gaan",
  "  alleen over wat er gegeten is. Is budget.avg_activity_points_per_day groter dan nul,",
  "  benoem dat dan wanneer je over budget of naleving schrijft — anders lijkt een",
  "  gemiddelde boven het dagbudget een overschrijding die het niet was.",
  "- activity.top_activities zegt wélke beweging het is en hoe lang. Een advies over bewegen",
  "  hoort daarop aan te sluiten in plaats van iets nieuws voor te stellen.",
  "- Het dagbudget is geen harde grens. Wat erboven uitkomt gaat uit de weekbuffer",
  "  (budget.weekly_buffer); buffer.avg_weekly_used zegt hoeveel daarvan opgaat.",
  "- Dagen zonder logboek tellen nergens als nul mee. Overal waar een gemiddelde staat,",
  "  staat het aantal dagen erbij; noem dat aantal als het klein is.",
  "- by_meal is het aandeel per maaltijd, by_time_of_day per tijdblok. Die twee zeggen iets",
  "  anders: een laat diner en een avondsnack vallen in hetzelfde tijdblok.",
  "- weight.body is wat een weegschaal met lichaamsanalyse meegaf: vet, spier, vocht, BMI,",
  "  met het verloop over het venster. Null betekent niet gemeten. Zijn die er, weeg ze dan",
  "  mee: gewicht dat zakt terwijl de spiermassa meezakt is iets anders dan vet dat eraf gaat.",
  "  measurements_counted zegt op hoeveel metingen dat verloop rust.",
  "- Punten staan al geschaald zoals de persoon ze in de app ziet.",
  "",
  "WAT JE KIEST",
  ...
  "Schrijf de sleutelnamen niet over in je tekst: \"adherence_rate\" en \"top_contributors\"",
  "zijn namen uit het pakket, geen Nederlands. Zeg wat het getal betekent.",
  "",
  "TOON",
