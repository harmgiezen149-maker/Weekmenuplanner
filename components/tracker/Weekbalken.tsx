...
// kleur te zien is.
//
// Bovenop de staaf staat in het groen wat er die dag met bewegen verdiend is.
// Het echte eten staat onderin: zo is in één oogopslag te zien wat er
// werkelijk over budget is (het gekleurde deel tot aan de budgetlijn) en wat
// beweging daar nog aan ruimte bovenop heeft gezet. Dat is geen tweede
// budgetlijn: het dagbudget blijft wat het is, er komt alleen ruimte bij. Een
// streep op "budget plus beweging" zou een budget suggereren dat per dag
// verschuift, en dat is niet hoe het werkt.
// ---------------------------------------------------------------------------
    ...
    <figure style={{ margin: 0 }}>
      ...
      >
        ...
        {week.dagen.map((d, i) => {
          ...
          // De groene kop is niet meer dan er die dag gegeten is: een
