...
export const T: Record<string, React.CSSProperties> = {
  ...
  aantalRij: { display: "flex", alignItems: "center", gap: 10, padding: "10px 15px", borderBottom: "1px solid var(--line)", background: "var(--bg)", flexWrap: "wrap" },
  aantalUitleg: { flex: 1, minWidth: 90, fontSize: 12, color: "var(--sub)", lineHeight: 1.4 },
  aantalKnop: { padding: "8px 14px", borderRadius: 9, border: "none", background: "var(--accent)", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", flexShrink: 0 },
  ...
  stapper: { display: "flex", alignItems: "stretch", border: "1px solid var(--line)", borderRadius: 10, background: "var(--surface)", overflow: "hidden" },
  stapKnop: { display: "flex", alignItems: "center", justifyContent: "center", width: 40, flexShrink: 0, border: "none", background: "var(--bg)", color: "var(--ink)", cursor: "pointer" },
  stapVeld: { flex: 1, minWidth: 0, padding: "10px 4px", border: "none", background: "transparent", color: "var(--ink)", fontSize: 15, fontWeight: 700, textAlign: "center", outline: "none" },
  veldVak: { flex: 1, minWidth: 0, marginBottom: 12 },
  meerKnop: { display: "inline-flex", alignItems: "center", gap: 6, background: "none", border: "none", color: "var(--accent)", fontSize: 13, fontWeight: 700, cursor: "pointer", padding: "8px 0 0" },
  samenstelling: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(104px, 1fr))", gap: 8, marginTop: 12 },
  meetVak: { background: "var(--bg)", border: "1px solid var(--line)", borderRadius: 10, padding: "8px 10px" },
  meetWaarde: { display: "flex", alignItems: "baseline", gap: 5, fontSize: 15.5, fontWeight: 800, letterSpacing: "-0.01em" },
  meetVerschil: { fontSize: 11.5, fontWeight: 700, color: "var(--sub)" },
  meetLabel: { fontSize: 11, color: "var(--sub)", fontWeight: 600, marginTop: 2 },
